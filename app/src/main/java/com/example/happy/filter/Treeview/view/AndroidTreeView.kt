package com.example.happy.filter.Treeview.view
...
import com.example.happy.filter.Treeview.Holder.SimpleViewHolder
        ...
        view.addView(viewTreeItems)
            ...
            mRoot!!.setViewHolder(object : TreeNode.BaseNodeViewHolder<Any>(mContext!!){
                override fun createNodeView(node: TreeNode?, value: Any?): View? {
                    var view = LayoutInflater.from(mContext).inflate(R.layout.single_parent_item,null,false)
                    view.findViewById<TextView>(R.id.name_of_agent).text = "fgfgfgfg"
                    return view
                }
